#Convert user input to float and sotre in futureValue
futureValue = float(input("Enter the desired futrue value: "))

#Convert user input to float and store in rate
rate = float(input("Enter the annual interest rate: "))

#convert user input to integer and storoe in years
years = int(input("How many years will you let the money grow?"))

#Calculate presnt value and store in presentValue
